...
class appAppKernelProdContainer extends Container
{
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1fvSZ3fSTBvfYf3Tubp5dFrdmuQTeeAe5N6I9Trz8D4r9p1HDtszbSZzgHiTDQ9z'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                28 => 'ps_cashondelivery',
                29 => 'statscatalog',
                30 => 'psxmarketingwithgoogle',
                31 => 'ps_crossselling',
                32 => 'psxdesign',
                33 => 'statsforecast',
                34 => 'ps_wirepayment',
                ...
                68 => 'graphnvd3',
                69 => 'ps_viewedproduct',
                70 => 'statsbestsuppliers',
                71 => 'ps_faviconnotificationbo',
                72 => 'statsbestmanufacturers',
                73 => 'statsbestvouchers',
                74 => 'gridhtml',
                75 => 'statssearch',
                76 => 'statscarrier',
                77 => 'gsitemap',
            ...
            'secret' => '1fvSZ3fSTBvfYf3Tubp5dFrdmuQTeeAe5N6I9Trz8D4r9p1HDtszbSZzgHiTDQ9z',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-04-12',
            'locale' => 'es-MX',
            ...
            'new_cookie_key' => 'def000009c30c859fc83e90a6907e064226f1e3bc42235da8fc87c358ea644764ec67ed2282797f23cb20c869d5a8aa48124113ceda873917131530adda03bcc150b5848',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAigYK0liN6FWMX4RHMMwr'."\n".'VT5b8KdYOjfeMkQmadZnq/3p1rmiYqTsxN6ISQZ5Z5aFuPCAYna87pp4tgs9b2GC'."\n".'rUFOGpcFzYUbqcCkQ/UfW5jY7DYtyO/X0MNLtTVWgqDsZSeAu4qMPJW+BH8NiJcL'."\n".'to9WhDUslUzsSXSHKxcq8AidV7m5U98qwtDK/1u5+t6zjuLaiEscBw260FnpCjDT'."\n".'35thAiByjzJn78DljI9Z+8mR/g+Oln/ShKyO+xzzwzEMPOVO86zayVeCR3cFA56A'."\n".'l4MfMOHjDfcpwx1UPYnNGgnrhm0DTsd86m/xXTp7do2IIme/szJn9jSzqCDtGRUO'."\n".'nQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            ...
            'modules_translation_paths' => [
                ...
                26 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                ...
                32 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                ...
                41 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                ...
                48 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
            ...
            'kernel.secret' => '1fvSZ3fSTBvfYf3Tubp5dFrdmuQTeeAe5N6I9Trz8D4r9p1HDtszbSZzgHiTDQ9z',
