...
($context["categoriesKpi"] ?? null)]));
  ...
  ";
    ...
    public function block_categories_listing($context, array $blocks = [])
    {
        ...
        // line 49
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Sell/Catalog/Categories/index.html.twig", "@PrestaShop/Admin/Sell/Catalog/Categories/index.html.twig", 49, "78430512")->display(twig_array_merge($context, ["grid" => ($context["categoriesGrid"] ?? null)]));
        // line 58
        echo "  ";
    }
...
/* @PrestaShop/Admin/Sell/Catalog/Categories/index.html.twig */
class __TwigTemplate_4066a920ddebb08ce6b66f38b6837fa4___78430512 extends Template
{
    private $source;
    private $macros = [];
