...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_661a1a65bb0738_89852666',
...
function content_661a1a65bb0738_89852666 (Smarty_Internal_Template $_smarty_tpl) {
?>
  <div id="carousel" data-ride="carousel" class="carousel slide" data-interval="5000" data-wrap="true" data-pause="hover" data-touch="true">
    ...
    <ul class="carousel-inner" role="listbox" aria-label="Contenedor carrusel ">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://192.168.32.2/modules/ps_imageslider/images/sample-1.jpg" alt="sample-1" loading="lazy" width="1110" height="340">
          ...
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://192.168.32.2/modules/ps_imageslider/images/sample-2.jpg" alt="sample-2" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
              ...
              <li class="carousel-item " role="option" aria-hidden="true">
          <a href="https://www.prestashop-project.org">            <figure>
              <img src="http://192.168.32.2/modules/ps_imageslider/images/sample-3.jpg" alt="sample-3" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
