...
<head>
  ...
  <title>{block name='page_title'}{$page.meta.title|escape:'html':'UTF-8'}{/block}</title>
...
<script src="/themes/classic/assets/js/js/bootstrap.bundle.js"></script>



  {block name='stylesheets'}
    {if isset($css_files)}
      {foreach from=$css_files key=css_key item=css_uri}
